...
| [`implement`](idea-to-ship/skills/implement/SKILL.md) | Implement `architecture.md` stage by stage, requiring TDD evidence for production or behavior-changing work. |
...
| [`ui-design`](idea-to-ship/skills/ui-design/SKILL.md) | Design the UI/UX contract for an idea-to-ship slug from requirements, architecture, and the existing design system. |
...
| [`fix-issue`](issue-evaluator/skills/fix-issue/SKILL.md) | Implement a GitHub issue fix from an evaluation report or issue description. |
