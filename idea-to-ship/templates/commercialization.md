# Commercialization Artifact Template
...
<2-4 CS items from commercial-scenario.md when starting from a fuzzy idea; otherwise state why existing requirements already define the scenario>
...
<table using CH IDs from commercial-review-and-hypothesis.md>
