...
CHECKS: tuple[ContractCheck, ...] = (
    ...
    ContractCheck(
        ...
        (
            InvariantGroup("usage stats read-only boundary", (r"usage-stats", r"read-only and conversation-only")),
            InvariantGroup("cleaner report mode", (r"skill-cleaner-report", r"evidence bundle")),
            InvariantGroup("cleaner plan mode", (r"skill-cleaner-plan", r"plan bundle")),
            InvariantGroup("cleaner apply mode", (r"skill-cleaner-apply", r"--approved-plan-sha")),
            InvariantGroup("report mutation boundary", (r"no target, config, or skill-root mutation",)),
            InvariantGroup("outputs written", (r"`outputs_written`", r"evidence bundle")),
            InvariantGroup("no git mutation", (r"git add", r"git commit", r"git push", r"never")),
            InvariantGroup("typed errors", (r"`retryable`, `terminal`, `needs_user`, or `degraded`",)),
            InvariantGroup("truncated field", (r"`truncated`", r"`true` or `false`")),
    ...
    ContractCheck(
        ...
        (
            InvariantGroup("usage mode no writes", (r"usage-statistics", r"outputs_written: \[\]")),
            InvariantGroup("frontmatter apply-confirm", (r"description: .*apply-confirm scoped cleanup",)),
            InvariantGroup("cleaner flag", (r"--cleaner", r"skill-cleaner report")),
            InvariantGroup("wrapper report command", (r"skill_cleaner_wrapper\.py report",)),
            InvariantGroup("analyzer configuration", (r"--analyzer", r"SKILL_STATS_CLEANER_ANALYZER")),
            InvariantGroup("cleaner report artifact", (r"evidence_bundle", r"outputs_written")),
            InvariantGroup("cleaner report boundary", (r"no target, config, or skill-root mutation",)),
            InvariantGroup("apply gate", (r"--apply", r"preflight-plan", r"/plan", r"--approved-plan-sha")),
            InvariantGroup("apply no git", (r"git add", r"git commit", r"git push", r"never")),
            InvariantGroup("shared contract cited", (r"\.\./\.\./WORKFLOW-CONTRACTS\.md",)),
        ),
    ),
    ContractCheck(
        "skill-stats-readme-portfolio-contract",
        "README.md",
        (
            InvariantGroup("readme cleaner report", (r"skill-cleaner report", r"`--cleaner`")),
            InvariantGroup("readme analyzer setup", (r"`--analyzer`", r"`SKILL_STATS_CLEANER_ANALYZER`")),
            InvariantGroup("readme report-only default", (r"report-only by default",)),
            InvariantGroup("readme apply confirm", (r"apply-confirm", r"`--apply`", r"`/plan`")),
        ),
    ),
    ContractCheck(
        "skill-stats-portfolio-contract",
        "PORTFOLIO.md",
        (
            InvariantGroup("portfolio cleaner report", (r"skill-cleaner report",)),
            InvariantGroup("portfolio report-only default", (r"report-only by default",)),
            InvariantGroup("portfolio evidence artifact", (r"evidence bundle",)),
            InvariantGroup("portfolio apply confirm", (r"apply-confirm", r"`--apply`")),
        ),
    ),
    ContractCheck(
